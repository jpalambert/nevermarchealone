...
<center>
							...
							<form name="sentMessage" id="contactForm" novalidate>
								...
								<div class="row">
									<div
										...
										<td style="margin-left: 25px;"><form:radiobutton
												path="etat" value="accompagne" checked="checked" /> Je
	...
	<div class="box">
		<div class="col-lg-12">
			<h4>
				<a href="<c:url value='/subscribe' />">je ne possède pas de
					compte, je souhaite m'inscrire</a>
			</h4>
		</div>
	</div>
</center>
